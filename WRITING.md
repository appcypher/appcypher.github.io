...
W, H = 960, 300
# faces and objects "boil" (three inkings cycled by CSS): D.boil_face for people (their backing stays still), D.boil for objects and arrows; words, bubbles and stamps stay still
...
s += D.boil(lambda pen: D.arrow(pen, (250, 140), (730, 140), w=2.2), 404) + D.place(D.boil(lambda pen: D.obj(pen, "key", "ochre"), 303), 460, 82, 0.9)
