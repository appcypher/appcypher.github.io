...
Personal Jekyll blog for https://appcypher.github.io — a notebook with a fixed left rail, monospaced type, paper grain, and hand-drawn doodles generated from a small pen engine. Dark by default, with a light theme. The design is documented in `DESIGN.md`.
